...
use App\Mail\ApproveRejectbookEmail;
    ...
    public function ApprovalBook(Request $request){
        ...
        if ($show_book == 'R') {
           ...
           // return $data;
            ...
            $data1=MdUserLogin::find($pub_id);
            $email=$data1->user_id;
            $user_name=$data1->user_name;
            $book_name=$data->book_name;
            $app_rej="Approve";
            // Mail::to($email)->send(new ApproveRejectbookEmail($user_name,$book_name,$app_rej));
            // end notification
            $msg = 'success';
            $success=1;
            $approved_book = 'Y';
